...
It's clear that testing is important, but what should you test? Apparently, and especially for frontend apps (including mobile apps), there is no clear answer. Should I aim for 100% code coverage? Should I test every component?
...
Focus on the above and write unit tests for them. this will help you get the most out of your tests and will help you find bugs early on.
