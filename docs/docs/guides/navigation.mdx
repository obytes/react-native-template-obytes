...
import AuthNavigator from "!!raw-loader!../../../template/src/navigation/auth-navigator";
...
Here is a simple example of the auth stack navigator.

<CodeBlock title="src/navigation/auth-navigator.tsx" language="tsx">
  {AuthNavigator}
</CodeBlock>
