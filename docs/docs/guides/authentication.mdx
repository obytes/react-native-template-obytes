...
import AuthStore from "!!raw-loader!../../../template/src/core/auth";
import RootNavigator from "!!raw-loader!../../../template/src/navigation/root-navigator";
...
```tsx
import { useAuth, signOut, hydrate } from "@/core";
