...
:::tip
Use `useq` snippet to generate query in no time using vscode : [🔗](#create-api-hooks-with-vs-code-snippets)
...
:::tip
Use `usem` snippet to generate mutation in no time using vscode : [🔗](#create-api-hooks-with-vs-code-snippets)
