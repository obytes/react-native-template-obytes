...
import  useThemeConfig  from '!!raw-loader!../../../src/core/hooks/use-theme-config';
...
we add the colors in `ui/theme/colors.js`  and we use them in our hook `useThemeConfig.tsx`  to generate the theme object that we pass to react-navigation container. for more information check out [react-navigation](https://reactnavigation.org/docs/themes/)
