...
this template comes with dark mode support out of the box, and it's very easy to change the color scheme of your app. thanks to [tailwindcss](https://tailwindcss.com/docs/dark-mode)
...
also we use useSelectedTheme hook to get the current theme and use it to change the theme of the app.
