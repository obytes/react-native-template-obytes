...
Since we’re using nativewind(that Tailwind CSS under the hood) and react-navigation we let theme handle applying it ,and  we just take care of the colors we want .  
