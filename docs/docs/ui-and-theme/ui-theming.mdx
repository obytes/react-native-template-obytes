...
Since we’re using [nativewind](https://www.nativewind.dev/)(that use Tailwind CSSunder the hood) and react-navigation we let theme handle applying it ,and  we just take care of the colors we want .  
