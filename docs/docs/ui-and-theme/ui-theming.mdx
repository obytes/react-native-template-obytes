...
We have created a `ui/theme` folder when you can finds our costume colors that has been imported to `tailwind.config.js` and used as a theme for our demo application. You can add your own colors palette and use them in your component with Tailwind class names.
