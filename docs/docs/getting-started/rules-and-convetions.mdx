...
This starter uses Typescript to provide type safety and to avoid common bugs in the codebase. The project configuration is based on expo config with some updates to support absolute import.
