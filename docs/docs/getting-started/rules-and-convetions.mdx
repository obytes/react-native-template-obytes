...
import EslintConfig from "!!raw-loader!../../../template/.eslintrc.js";
import PreCommit from "!!raw-loader!../../../template/.husky/pre-commit";
import PostMerge from "!!raw-loader!../../../template/.husky/post-merge";
import CommitMsg from "!!raw-loader!../../../template/.husky/commit-msg";
...
This starter uses Typescript to provide type safety and to avoid common bugs in the codebase. The project configuration is based on expo config with some updates to support absolute important.

<!-- <CodeBlock language="json">{Config}</CodeBlock> -->
...
<CodeBlock language="js">{EslintConfig}</CodeBlock>
...
<CodeBlock language="bash">{PreCommit}</CodeBlock>
...
<CodeBlock language="bash">{PostMerge}</CodeBlock>
...
<CodeBlock language="bash">{CommitMsg}</CodeBlock>
