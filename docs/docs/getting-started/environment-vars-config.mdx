...
import ConfigJs from "!!raw-loader!../../../template/config/config.js";

import ConfigTs from "!!raw-loader!../../../template/config/index.ts";
import APICommons from "!!raw-loader!../../../template/src/api/common/client.tsx";
