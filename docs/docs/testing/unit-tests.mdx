...
import LoginForm from '!!raw-loader!../../../src/screens/login/login-form';
import TestForm from '!!raw-loader!../../../src/screens/login/login-form.test';
import TestUtils from '!!raw-loader!../../../src/core/test-utils';
...
If you are not familiar with the React Native Testing Library, we recommend reading the [official documentation](https://callstack.github.io/react-native-testing-library/) to get familiar with it.
...
<CodeBlock language="tsx" title="./src/screens/login/login-form.tsx">
  {LoginForm}
</CodeBlock>
...
<CodeBlock language="tsx" title="./src/core/test-utils">
  {TestUtils}
</CodeBlock>
:::
...
![GitHub action output](./img/github-action-output.png)
