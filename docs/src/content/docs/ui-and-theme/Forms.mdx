...
See `src/app/feed/add-post.tsx` for a complete example that demonstrates:
...
- [Example: Login Form](https://github.com/obytes/react-native-template-obytes/blob/master/src/components/login-form.tsx)
- [Example: Add Post Form](https://github.com/obytes/react-native-template-obytes/blob/master/src/app/feed/add-post.tsx)
- [Utility: getFieldError](https://github.com/obytes/react-native-template-obytes/blob/master/src/lib/form-utils.ts)
